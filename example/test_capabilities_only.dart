...
import 'package:flutter_mcp_client_lib/src/models/mcp_capabilities.dart';
...
void main() {
  ...
  print(
      'Resources - list: ${capabilities.resources?.list}, read: ${capabilities.resources?.read}');
  print(
      'Tools - list: ${capabilities.tools?.list}, call: ${capabilities.tools?.call}');
  print(
      'Prompts - list: ${capabilities.prompts?.list}, get: ${capabilities.prompts?.get}');
